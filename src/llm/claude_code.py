"""Backend A — Claude Code (`claude -p`), your Max subscription.
...
DEFAULT_MODEL = "claude-haiku-4-5"  # the "weak model" target; eval validates it
...
class ClaudeCodeBackend(LLMBackend):
    ...
    def _once(self, prompt, schema, system):
        ...
        # global ~75-130k-token MCP set is what makes a naive `claude -p` slow /
