"""Pluggable LLM backend for the yoke pipeline.
...
Selection (predictable, no surprises from stray keys):
  ...
  • else OPENROUTER_API_KEY set  -> OpenAICompatBackend('openrouter')
...
`backend.describe()` (e.g. "claude-code:claude-haiku-4-5") feeds the consent line.
"""
import os
